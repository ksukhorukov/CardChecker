class Cards
  module FormatValidation
    ...
    def format_validation
      raise RuntimeError, ERROR_INVALID_CARD_FORMAT unless card_number_consists_of_digits?
      raise RuntimeError, ERROR_INVALID_CARD_LENGTH if card_length_acceptable?
    end
  end
end
